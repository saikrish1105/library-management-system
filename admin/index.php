...
<html>
    ...
    <body>
        ...
        <span><marquee>Get your admin credentials from CTC or mail to lms.helpdesk@vit.ac.in</marquee></span><br><br>
        <div class="row">
                    ...
                    if(isset($_POST['email'])){
                        ...
                        while($row = mysqli_fetch_assoc($query_run)){
                            if($row['password'] == $_POST['password']){
                                ...
                                header("Location: admin_dashboard.php"); // To redirect to user dashboard
                            }
                            else{
                                ?>
