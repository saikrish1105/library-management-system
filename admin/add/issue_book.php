...
<html>
    ...
    <body>
        ...
        <span style="color:red;"><marquee>Make sure the category details are correct before adding them</marquee></span><br><br>
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="book_author">
                            ...
                            <?php
                                ...
                                $db=mysqli_select_db($connection,"lms"); //database selection 
                   ...
                   </div> <!--to get the current date when you are issuing-->
                    </div>
...
<?php
    if(isset($_POST['issue_book']))
    {
        ...
        $query="insert into issued_book values(null,$_POST[book_no],'$_POST[book_name]','$_POST[book_author]',$_POST[student_id],1,'$_POST[issue_date]')";
        $query_run=mysqli_query($connection,$query);
    }
?>